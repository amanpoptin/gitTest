  ...
  <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
    ...
    <div class="navbar-menu-wrapper text-center align-items-center justify-content-end">
      ...
      <div class="nav-action-button">
        <button type="button" class="btn btn-primary-light btn-sm btn-radius" onClick="poptinRedirect('popups.php');">Back</button>
          ...
          <div class="row poptin-steps mb-3 template-type-selection">
            <div class="col-md-3 col-lg-3 col-sm-12">
              <div class="card setps-card"> <a href="#" data-type="leads" data-fContainer=".templates-preview-container"> <i class="icon icon-leads"></i>
                ...
                <span class="card-title">Get more leads</span> </a> </div>
            </div>
            <div class="col-md-3 col-lg-3 col-sm-12">
            ...
            <div class="col-md-3 col-lg-3 col-sm-12">
              <div class="card setps-card"> <a href="#" data-type="announcements" data-fContainer=".templates-preview-container"> <i class="icon icon-free"></i>
                <p class="step-info-text">we've implemented the widget and connected it to our within minutes. rate skyrocketed!</p>
                <span class="card-title">Announcements</span> </a> </div>
            </div>
            <div class="col-md-3 col-lg-3 col-sm-12">
              <div class="card setps-card"> <a href="#" data-type="grow-email-list" data-fContainer=".templates-preview-container"> <i class="icon icon-emails"></i>
                <p class="step-info-text">we've implemented the widget and connected it to our within minutes. rate skyrocketed!</p>
                <span class="card-title">Grow email list</span> </a> </div>
            </div>
          </div>
         ...
         <div class="templates-filters-head p-4">
            <ul class="simplefilter">
              <span class="filter-text"> Fillter by type:</span>
				...
				<li class="fltr-controls active" data-filter="1">Lightbox</li>
              <li class="fltr-controls" data-filter="2">Bar</li>
              <li class="fltr-controls" data-filter="3">Slide-In</li>
              <li class="fltr-controls" data-filter="4">Full screen</li>
              <li class="fltr-controls" data-filter="5">Mobile only</li>
            </ul>
         </div>   
            <div class="filtr-container">
              <div class="col-xs-6 col-sm-4 col-md-3 filtr-item" data-category="1, 5" data-sort="Busy streets"> <img class="img-responsive" src="assets/images/template-img.jpg" alt="sample image"> <span class="item-btns">
                <button type="button" class="btn btn-primary-light btn-sm btn-radius btn-template-preview" data-format="format_1">Preview</button>
                 <button type="button" class="btn btn-info btn-sm btn-radius" onClick="poptinRedirect('customize.php');" >Customize</button>                </span> </div>
